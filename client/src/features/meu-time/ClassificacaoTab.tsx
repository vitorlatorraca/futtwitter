...
export function ClassificacaoTab({ userTeamId }: ClassificacaoTabProps) {
          ...
          <table className="w-full min-w-[640px]">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left p-4 text-xs font-semibold text-muted-foreground tracking-wider">#</th>
                <th className="text-left p-4 text-xs font-semibold text-muted-foreground tracking-wider">Time</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">P</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">V</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">E</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">D</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider hidden md:table-cell">DIFF</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider hidden lg:table-cell">Gols</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">Last 5</th>
                <th className="text-center p-4 text-xs font-semibold text-muted-foreground tracking-wider">PTS</th>
              </tr>
            </thead>
            <tbody>
  ...
  return (
    <div className="rounded-2xl border border-border bg-surface-card overflow-hidden shadow-xl transition-all duration-300">
      {/* Header */}
      <div className="p-5 border-b border-border bg-surface-elevated/50">
      ...
      <div className="overflow-x-auto max-h-[calc(100vh-280px)] overflow-y-auto">
        <table className="w-full min-w-[640px]">
          <thead className="sticky top-0 z-10 bg-surface-card border-b border-border">
            <tr>
              <th className="text-left py-3.5 px-3 sm:px-4 text-[11px] font-semibold text-muted-foreground tracking-wider w-10">#</th>
              <th className="text-left py-3.5 px-3 sm:px-4 text-[11px] font-semibold text-muted-foreground tracking-wider min-w-[140px] sm:min-w-[180px]">Time</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-10 hidden sm:table-cell">P</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-10 hidden sm:table-cell">V</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-10 hidden sm:table-cell">E</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-10 hidden sm:table-cell">D</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-12 hidden md:table-cell">DIFF</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-14 hidden lg:table-cell">Gols</th>
              <th className="text-center py-3.5 px-2 text-[11px] font-semibold text-muted-foreground tracking-wider w-[100px] sm:w-[110px]">Last 5</th>
              <th className="text-center py-3.5 px-3 sm:px-4 text-[11px] font-semibold text-muted-foreground tracking-wider w-12">PTS</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3.5 px-2 text-center text-success font-semibold tabular-nums text-sm hidden sm:table-cell">{row.wins}</td>
                  ...
                  <td className={`py-3.5 px-2 text-center font-semibold tabular-nums text-sm hidden md:table-cell ${
                    row.goalDiff > 0 ? 'text-success' : row.goalDiff < 0 ? 'text-rose-400/90' : 'text-muted-foreground'
                  }`}>
                    ...
                    <div className="flex gap-1 justify-center">
                      ...
                      {(!row.form || row.form.length < 5) &&
                        Array.from({ length: 5 - (row.form?.length ?? 0) }).map((_, i) => (
                          <span
                            key={`empty-${i}`}
                            className="inline-flex w-[18px] h-[18px] rounded-[4px] border border-dashed border-border items-center justify-center text-[10px] text-muted-foreground"
                          >
                            —
                          </span>
                        ))}
      ...
      {/* Legend */}
      <div className="p-4 border-t border-border bg-surface-elevated/30 flex flex-wrap gap-4 text-xs text-muted-foreground">
