...
// Brasileirão Série A 2026 — 20 teams
// CDN URLs from media.api-sports.io (API-Football)
export const TEAMS_DATA: TeamData[] = [
  ...
  { id: 'mirassol',             name: 'Mirassol',              shortName: 'MIR', logoUrl: 'https://media.api-sports.io/football/teams/1185.png', primaryColor: '#FFD700', secondaryColor: '#000000' },
  ...
  { id: 'vitoria',              name: 'Vitória',               shortName: 'VIT', logoUrl: 'https://media.api-sports.io/football/teams/1177.png', primaryColor: '#E31837', secondaryColor: '#000000' },
  ...
  { id: 'chapecoense',          name: 'Chapecoense',           shortName: 'CHA', logoUrl: 'https://media.api-sports.io/football/teams/741.png',  primaryColor: '#007A3D', secondaryColor: '#FFFFFF' },
  { id: 'remo',                 name: 'Remo',                  shortName: 'REM', logoUrl: 'https://media.api-sports.io/football/teams/1220.png', primaryColor: '#003087', secondaryColor: '#FFFFFF' },
];
